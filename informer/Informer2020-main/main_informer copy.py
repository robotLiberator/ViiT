...
print(args)
cofformer = Informer(enc_in=7, dec_in=7, c_out=7, seq_len=96, label_len=48, out_len=24)

param_size = 0
param_sum = 0

for param in cofformer.parameters():
    param_size += param.nelement() * param.element_size()
    param_sum += param.nelement()
print(param_sum)
buffer_size = 0
buffer_sum = 0
for buffer in cofformer.buffers():
